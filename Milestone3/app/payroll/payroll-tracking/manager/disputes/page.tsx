...
import { payrollManagerApi, DisputeDto } from '@/services/api';
        ...
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Approve to send to finance for processing, or reject to close the dispute
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {loading ? (
                                            ...
                                            {dispute.status === 'PENDING' && (
                                                <>
                                                    <Button
                                                        ...
                                                        onClick={() => handleQuickAction(dispute._id, 'APPROVE')}
                                                    >
                                                    ...
                                                    <Button
                                                        size="sm"
                                                        variant="destructive"
                                                        onClick={() => handleQuickAction(dispute._id, 'REJECT')}
                                                    >
