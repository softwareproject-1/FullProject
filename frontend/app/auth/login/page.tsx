...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Determine which identifier type to use
      let identifierValue = '';
      let identifierType: 'workEmail' | 'personalEmail' | 'nationalId' = 'nationalId';
      
      if (identifier) {
        identifierValue = identifier;
        identifierType = 'nationalId';
      } else if (workEmail) {
        identifierValue = workEmail;
        identifierType = 'workEmail';
      } else if (personalEmail) {
        identifierValue = personalEmail;
        identifierType = 'personalEmail';
      }
      
      await login(identifierValue, password, identifierType);
